...
$motdepasse = "Alex$42man"; // Mot de passe MySQL
...
$sql = "INSERT INTO login (nom, prenom, email, mot_de_passe, personnage_prefere, age) 
        VALUES ('$nom', '$prenom', '$email', '$mot_de_passe', $personnage_prefere', '$age')";
